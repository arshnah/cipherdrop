...
export default function Cipherdrop() {
  return (
    <main className="min-h-screen">
      <div className="mx-auto max-w-[1060px] px-6">
        <nav className="flex items-center justify-between py-6">
          <span className="font-mono font-semibold text-[15px] tracking-tight flex items-center gap-2.5">
            <a href="/" className="text-faint hover:text-ink transition">drop</a>
            <span className="text-faint">/</span>
            <span className="flex items-center gap-2"><span className="w-3 h-3 bg-accent" /> cipherdrop</span>
          </span>
        ...
        <footer className="py-9 border-t border-line font-mono text-[12.5px] text-faint flex items-center justify-between">
          <span>made by <a href="https://arshnah.in" className="text-muted hover:text-ink transition">arshdeep singh</a></span>
          <span>MIT</span>
        </footer>
      </div>
    </main>
